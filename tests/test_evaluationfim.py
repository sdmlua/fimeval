...
Main_dir = "/Users/Supath/Downloads/SDML/FIMeval/test-FIMs"  # This is the main directory where all the cases are stored. It should have subfolders for each case and inside each case folder, there should be the FIMs to be evaluated. The structure should be like this: Main_Directory/Case1/FIMs, Main_Directory/Case2/FIMs, and so on.
PWD_dir = "./path/to/PWB"
